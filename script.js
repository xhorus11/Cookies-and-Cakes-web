...
const productsData = [
    // --- TORTAS (8 ejemplos) ---
    { id: 'torta-chocolate', category: 'torta', name: 'Torta de Ciruela', price: '$40.000 - $50.000', image_card: 'https://i.imgur.com/GwNkAJA.jpeg', description: '୨୧ Bizcocho firme de ciruelas con nueces, relleno de crema de ciruelas y manjar.<br><br>୨୧ Disponible para 20 y 25 personas. ', materials: [ 'Harina de trigo', 'Cacao en polvo', 'Huevos de campo', 'Frambuesas frescas', 'Manjar casero', 'Chocolate' ] },
    ...
    { id: 'torta-zanahoria', category: 'torta', name: 'Kuchen de Nuez', price: '$18.000', image_card: 'https://i.imgur.com/sNk6xWC.jpeg', description: '୨୧ Suave masa, relleno de una delicada crema de manjar y nuez.<br><br>୨୧ Disponible para 10 a 15 personas.', materials: [ 'Zanahoria', 'Harina integral', 'Nueces', 'Canela', 'Huevos', 'Queso crema' ] },
    { id: 'cheesecake-frutos-rojos', category: 'torta', name: 'Torta Amapolas', price: '$35.000 - $42.000', image_card: 'https://i.imgur.com/McNjkAs.jpeg', description: '୨୧ Bizcocho de amapolas, relleno de manjar, mermelada de frambuesa con chantilly y cubierta de crema Chantilly.<br><br>୨୧ Disponible para 20 y 25 personas.', materials: [ 'Queso crema', 'Crema de leche', 'Galletas', 'Mantequilla', 'Frutos rojos', 'Azúcar' ] },
