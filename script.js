...
const productsData = [
    ...
    { id: 'galletas-delicias', category: 'galleta', name: 'Galletas Delicias', price: '$1.800 c/u', image_card: 'https://placehold.co/400x400/E18AAA/FFFFFF?text=Galletas+Delicias', description: 'Una galleta única y sofisticada, cargada con trozos de nueces y almendras tostadas, con un toque de naranja. Una verdadera delicia.', materials: ['Harina', 'Mantequilla', 'Nueces', 'Almendras', 'Ralladura de naranja'] },
    ...
    { id: 'pie-limon', category: 'reposteria', name: 'Pie de Limón', price: '$16.000', image_card: 'https://placehold.co/400x400/E18AAA/FFFFFF?text=Pie+de+Limon', description: 'Clásico y refrescante pie de limón con una base de galleta crujiente, un relleno cremoso y un merengue italiano perfectamente dorado.', materials: ['Base de galleta', 'Leche condensada', 'Jugo de limón fresco', 'Huevos', 'Merengue italiano'] },
    { id: 'dulces-chilenos', category: 'reposteria', name: 'Pastelitos Chilenos', price: '$', image_card: 'https://i.postimg.cc/xjb8r5jf/Captura-de-pantalla-2025-07-13-152247.png', description: 'Nuestra bandeja rebosa sabor con los clásicos alfajores chilenos y chilenitos cubiertos de merengue, rellenos con suave manjar y decorados con azúcar flor, coco o nuez. Cada bocado es una explosión de nostalgia y dulzura artesanal', materials: [ 'Manjar', 'Huevos', 'Harina', 'Leche', 'Mantequilla' ] },
