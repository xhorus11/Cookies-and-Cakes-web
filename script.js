...
const productsData = [
    ...
    { id: 'galletas-rock', category: 'galleta', name: 'Torta Rock', price: '', image_card: 'https://i.imgur.com/yCJwqbS.jpeg', description: ' Modo rock, la cubierta está hecha de buttercream y el tono plateado son polvos comestibles y hecho con un aerógrafo manual 😉', materials: ['Harina', 'Mantequilla', 'Nueces', 'Almendras', 'Ralladura de naranja'] },
...
function initializePage() {
    ...
    if (footer) {
        ...
        <div class="footer-container">
            <div class="footer-column"><h4>Enlaces de Interés</h4><ul><li><a href="index.html">Inicio</a></li><li><a href="personalizados.html">Personalizados</a></li><li><a href="faq.html">Preguntas Frecuentes</a></li></ul></div>
            <div class="footer-column"><h4>Contacto</h4><div class="social-media"><a href="https://www.instagram.com/c_y_c_cookies_and_cakes/" target="_blank" aria-label="Instagram"><i class="fab fa-instagram"></i></a><a href="https://wa.me/56961961556" target="_blank" aria-label="WhatsApp"><i class="fab fa-whatsapp"></i></a></div></div>
