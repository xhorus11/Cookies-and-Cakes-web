...
const productsData = [
    ...
    { id: 'galletas-vainilla', category: 'galleta', name: 'Galletas Navideñas', price: '', image_card: 'https://i.imgur.com/4wdwr7X.jpeg', description: 'Tiernas galletas de mantequilla con un toque de vainilla, decoradas a mano con glaseado real. Perfectas para regalos y eventos.', materials: [ 'Harina', 'Mantequilla', 'Azúcar', 'Huevo', 'Vainilla', 'Azúcar glas' ] },
