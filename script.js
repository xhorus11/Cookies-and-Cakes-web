...
const productsData = [
    ...
    // --- GALLETAS (6 ejemplos) ---
    { id: 'galletas-surtidas', category: 'galleta', name: 'Galletas surtidas', price: 'Desde $2.000', image_card: 'https://i.postimg.cc/fLBCjsFK/Captura-de-pantalla-2025-07-13-144948.png', description: 'Deléitate con esta exquisita selección de galletas artesanales, perfectas para acompañar un café o endulzar cualquier momento del día. Cada pieza está elaborada con dedicación y variedad de sabores y texturas', materials: [ 'Chips de chocolate', 'Harina', 'Mantequilla', 'Azúcar rubia', 'Huevo', 'Bicarbonato' ] },
