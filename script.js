...
const productsData = [
    // --- TORTAS (8 ejemplos) ---
    { id: 'torta-chocolate', category: 'torta', name: 'Torta Amor', price: '$40.000 - $48.000', image_card: 'https://i.imgur.com/GwNkAJA.jpeg', description: '୨୧ Hojarascas rellenas con manjar, crema pastelera y chantilly con frambuesas enteras.<br><br>୨୧ Disponible para 20 y 25 personas. ', materials: [ 'Harina de trigo', 'Cacao en polvo', 'Huevos de campo', 'Frambuesas frescas', 'Manjar casero', 'Chocolate' ] },
