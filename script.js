...
const productsData = [
    ...
    // --- GALLETAS (6 ejemplos) ---
    { id: 'galletas-surtidas', category: 'galleta', name: 'Galletas surtidas', price: '', image_card: 'https://i.postimg.cc/J4PMwhyt/galletas-surtidas.jpg', description: 'Deléitate con esta exquisita selección de galletas artesanales, perfectas para acompañar un café o endulzar cualquier momento del día. Cada pieza está elaborada con dedicación y variedad de sabores y texturas', materials: [  'Harina', 'Mantequilla', 'Azúcar rubia', 'Huevo', 'Bicarbonato' ] },
    ...
    { id: 'galletas-delicias', category: 'galleta', name: 'Galletas Delicias', price: '', image_card: 'https://i.postimg.cc/B6LsF80t/galletas-delicias-2.jpg', description: 'Un clásico que nunca falla: nuestras galletas Delicias, su forma de flor y su centro brillante no solo las hacen irresistibles al paladar, sino también encantadoras a la vista. Crujientes por fuera, suaves por dentro… el equilibrio perfecto entre dulzura y textura.', materials: [ 'Mermelada', 'Harina', 'Mantequilla', 'Azúcar flor' ] },
    { id: 'galletas-personalizadas', category: 'galleta', name: 'Galletas personalizadas', price: '', image_card: 'https://i.postimg.cc/yYMPCxnB/galletas-personalizadas.jpg', description: 'Deliciosas galletas de mantequilla decoradas a mano con glasé real (royal icing), inspiradas en el mágico mundo de Hogwarts. Cada diseño está hecho con detalle y mucho amor: casas, varitas, bufandas y más… ¡Cotiza tu propio diseño único! ⚡🍪.', materials: [ 'Merengue', 'Harina', 'Mantequilla', 'Azúcar', 'Huevo' ] },
    ...
    { id: 'pie-de-limon', category: 'reposteria', name: 'Pie de limón', price: '$2.200 c/u', image_card: 'https://i.postimg.cc/W1KmsKXr/pie-de-limon-2.jpg', description: '🍋✨ Pie de Limón casero, con base crujiente, relleno cremoso y el toque justo de acidez. ¡Una delicia fresca y perfecta para cualquier momento!', materials: ['Leche condensada', 'Mantequilla', 'Azúcar', 'Huevos', 'Harina', 'Jugo de limón'] },
