...
const productsData = [
    ...
    // --- GALLETAS (6 ejemplos) ---
    { id: 'galletas-surtidas', category: 'galleta', name: 'Galletas surtidas', price: 'Desde $2.000 los 100gr', image_card: 'https://i.postimg.cc/fLBCjsFK/Captura-de-pantalla-2025-07-13-144948.png', description: 'Deléitate con esta exquisita selección de galletas artesanales, perfectas para acompañar un café o endulzar cualquier momento del día. Cada pieza está elaborada con dedicación y variedad de sabores y texturas', materials: [ 'Chips de chocolate', 'Harina', 'Mantequilla', 'Azúcar rubia', 'Huevo', 'Bicarbonato' ] },
    { id: 'torta pochacco', category: 'galleta', name: 'Galleta de Vainilla', price: '', image_card: 'https://i.postimg.cc/pd4cJK6N/galleta-de-vainilla.jpg', description: 'Exquisita galleta de vainilla decorada con royalcing', materials: [ 'Harina', 'Mantequilla', 'Azúcar', 'Huevo', 'Vainilla', 'Azúcar glas' ] },
    ...
    { id: 'galletas-avena-pasa', category: 'galleta', name: 'Galleta de Vainilla', price: '', image_card: 'https://i.postimg.cc/pd4cJK6N/galleta-de-vainilla.jpg', description: 'Exquisita galleta de vainilla decorada con royalcing', materials: [ 'Avena', 'Pasas', 'Harina', 'Canela', 'Mantequilla', 'Azúcar rubia' ] },
    { id: 'galletas-limon', category: 'galleta', name: 'Galletas Delicias', price: '', image_card: 'https://placehold.co/400x400/E18AAA/FFFFFF?text=Galletas+Limon', description: 'Galletas suaves y mantecosas con un intenso sabor a limón y un glaseado brillante.', materials: [ 'Limón', 'Harina', 'Mantequilla', 'Azúcar', 'Huevo' ] },
    ...
    { id: 'galletas-delicias', category: 'galleta', name: 'Galletas Delicias', price: '$1.800 c/u', image_card: 'https://i.postimg.cc/T1hrGDw8/galletas-delicias-2.jpg', description: 'Una galleta única y sofisticada, cargada con trozos de nueces y almendras tostadas, con un toque de naranja. Una verdadera delicia.', materials: ['Harina', 'Mantequilla', 'Nueces', 'Almendras', 'Ralladura de naranja'] },
