...
const productsData = [
    ...
    { id: 'galletas-delicias', category: 'galleta', name: 'Galletas Delicias', price: '', image_card: 'https://i.postimg.cc/pXh4CYNW/galletas-delicias-1.jpg', description: 'Un clásico que nunca falla: nuestras galletas Delicias, su forma de flor y su centro brillante no solo las hacen irresistibles al paladar, sino también encantadoras a la vista. Crujientes por fuera, suaves por dentro… el equilibrio perfecto entre dulzura y textura.', materials: [ 'Mermelada', 'Harina', 'Mantequilla', 'Azúcar flor' ] },
