...
const productsData = [
    ...
    { id: 'galletas-rock', category: 'galleta', name: 'Torta Rock', price: '', image_card: 'https://i.imgur.com/yCJwqbS.jpeg', description: ' Modo rock la cubierta está hecha de buttercream y el tono plateado son polvos comestibles y hecho con un #aerógrafo manual 😉
', materials: ['Harina', 'Mantequilla', 'Nueces', 'Almendras', 'Ralladura de naranja'] },
