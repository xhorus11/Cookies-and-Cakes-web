...
const productsData = [
    ...
    { id: 'galletas-vainilla', category: 'galleta', name: 'Torta Pochacco', price: '', image_card: 'https://i.imgur.com/rTmCbxo.jpeg', description: '', materials: [ 'Harina', 'Mantequilla', 'Azúcar', 'Huevo', 'Vainilla', 'Azúcar glas' ] },
    { id: 'galletas-craqueladas', category: 'galleta', name: 'Galletas Cars', price: '', image_card: 'https://i.imgur.com/cuYhAo6.jpeg', description: '', materials: [ 'Chocolate amargo', 'Cacao', 'Azúcar glas', 'Huevo', 'Harina' ] },
...
function initializePage() {
    ...
    if (pageName === 'index.html' || pageName === '') {
        ...
        if (sliderContainer) {
            const images = [images/torta-encanto.webp', 'images/galletas-animalitos.webp', 'images/galletas-navidad.jpg];
