...
const productsData = [
    ...
    // --- GALLETAS (6 ejemplos) ---
    { id: 'cookies-chocolate-chip', category: 'galleta', name: 'Galletas Minions', price: '', image_card: 'https://i.imgur.com/hkA4QXP.jpeg', description: 'La clásica galleta americana: crujiente por fuera, blanda por dentro y repleta de chips de chocolate semi-amargo.', materials: [ 'Chips de chocolate', 'Harina', 'Mantequilla', 'Azúcar rubia', 'Huevo', 'Bicarbonato' ] },
