...
const productsData = [
    ...
    { id: 'galletas-adviento', category: 'galleta', name: 'Calendario de Adviento', price: '$12.500', image_card: 'https://i.postimg.cc/CxQM6rBs/calendario-adviento.jpg', description: 'Presentamos nuestro Calendario de Adviento de 12 días con Galletas Decoradas, hechas con amor y dedicación para hacer de esta temporada un momento inolvidable. Cada día, descubre una nueva galleta decorada y deliciosa detrás de una de las 12 ventanas de nuestro calendario. ¡Perfecto para compartir con la familia y amigos!¡No te pierdas esta oportunidad de hacer de la temporada de Adviento un momento aún más dulce y mágico!', materials: ['Harina', 'Mantequilla', 'huevo', 'Azúcar'] }
