...
// ¡Asegúrate de que el 'id' y 'category' sean correctos!
const productsData = [
    // --- TORTAS ---
    {
        id: 'torta-chocolate',
...
function loadProductGrid() {
    ...
    // Filtrar productos si hay una categoría, si no, mostrar todos
        ...
        container.innerHTML = `
            <div class="product-detail-layout">
                ...
                <div class="product-detail-info">
                    ...
                    <a href="pedido-personalizado.html" class="btn btn-primary">Encargar o Personalizar</a>
                </div>
            </div>
        `;
    } else {
