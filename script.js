...
const productsData = [
    ...
    // --- GALLETAS (6 ejemplos) ---
    { id: 'galletas-surtidas', category: 'galleta', name: 'Galletas surtidas', price: 'Desde $2.000 los 100gr', image_card: 'https://i.postimg.cc/fynNMtZQ/galletas-surtiditas.jpg', description: 'Deliciosas galletas surtidas para elegir y disfrutar.', materials: [ 'Chips de chocolate', 'Harina', 'Mantequilla', 'Azúcar rubia', 'Huevo', 'Bicarbonato' ] },
