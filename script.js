...
const productsData = [
    // --- TORTAS (8 ejemplos) ---
    { id: 'torta-chocolate', category: 'torta', name: 'Torta de Ciruela', price: '$40.000 - $50.000', image_card: 'https://i.imgur.com/GwNkAJA.jpeg', description: '୨୧ Bizcocho firme de ciruelas con nueces, relleno de crema de ciruelas y manjar.<br><br>୨୧ Disponible para 25 personas. ', materials: [ 'Harina de trigo', 'Cacao en polvo', 'Huevos de campo', 'Frambuesas frescas', 'Manjar casero', 'Chocolate' ] },
