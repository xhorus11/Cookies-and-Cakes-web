...
const productsData = [
    ...
    { id: 'dulces-chilenos', category: 'reposteria', name: 'Dulces Chilenos', price: '$', image_card: 'https://i.postimg.cc/xjb8r5jf/Captura-de-pantalla-2025-07-13-152247.png', description: 'Nuestra bandeja rebosa sabor con los clásicos alfajores chilenos y chilenitos cubiertos de merengue, rellenos con suave manjar y decorados con azúcar flor, coco o nuez. Cada bocado es una explosión de nostalgia y dulzura artesanal', materials: [ 'Manjar', 'Huevos', 'Harina', 'Leche', 'Mantequilla' ] },
