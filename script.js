...
function initializePage() {
    ...
    if (footer) {
        ...
        <div class="footer-container">
            ...
            <div class="footer-column map-container"><h4>Ubicación para Retiros</h4><p>Maipú, Santiago, Chile</p><iframe src="https://maps.app.goo.gl/u1Z4pfjo1DQPsYaa6" width="100%" height="200" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe></div>
        </div>
